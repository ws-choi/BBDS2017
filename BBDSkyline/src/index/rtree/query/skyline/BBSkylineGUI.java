...
public class BBSkylineGUI implements Skyline_Query {
	...
	public BBSkylineGUI(RTree tree, JPanel target, Skyline_Query_Event query, long time) {
	...
	public BBSkylineGUI(RTree tree, Point_Float point) {
		this.tree=tree;
		this.point=point;
		this.sleep_time=0;
	}
