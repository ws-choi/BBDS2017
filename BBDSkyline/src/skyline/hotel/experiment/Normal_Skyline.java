...
public class Normal_Skyline implements Skyline_Query {
	...
	public Normal_Skyline(RTree tree, JPanel target, Skyline_Query_Event query, long time) {
	...
	public Normal_Skyline(RTree tree, Point_Float point) {
		this.tree=tree;
		this.point=point;
	}
